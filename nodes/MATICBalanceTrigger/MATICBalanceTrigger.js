...
class MATICBalanceTrigger extends events_1.default {
    constructor() {
        super();
        ...
        this.networks = [
            {
                ...
                name: 'network',
                type: 'options',
                options: [...ChainNetwork_1.PolygonNetworks],
                default: 'homestead'
            },
            {
                ...
                type: 'options',
                options: [...ChainNetwork_1.polygonNetworkProviders],
                default: 'polygon'
            },
            {
                label: 'RPC Endpoint',
        ...
        const executeTrigger = async () => {
            ...
            if (!newBalance.eq(lastBalance)) {
                if (triggerCondition === 'increase' && newBalance.gt(lastBalance)) {
                    const balanceInMATIC = ethers_1.utils.formatEther(ethers_1.BigNumber.from(newBalance.toString()));
                    const diffInMATIC = newBalance.sub(lastBalance);
                    const returnItem = {
                        newBalance: `${balanceInMATIC} MATIC`,
                        lastBalance: `${ethers_1.utils.formatEther(ethers_1.BigNumber.from(lastBalance.toString()))} MATIC`,
                        difference: `${ethers_1.utils.formatEther(ethers_1.BigNumber.from(diffInMATIC.toString()))} MATIC`,
...
//# sourceMappingURL=MATICBalanceTrigger.js.map