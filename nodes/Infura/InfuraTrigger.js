...
class InfuraTrigger extends events_1.default {
    constructor() {
        super();
        this.loadMethods = {
            async getSubscribeOperations(nodeData) {
                ...
                const filteredOperations = totalOperations.filter((op) => Object.prototype.hasOwnProperty.call(op.providerNetworks, 'infura') && op.providerNetworks['infura'].includes(network));
  ...
  "param2"
    ...
    async runTrigger(nodeData) {
        ...
        const wssProvider = `${ChainNetwork_1.infuraWSSAPIs[network]}${apiKey}`;
...
//# sourceMappingURL=InfuraTrigger.js.map