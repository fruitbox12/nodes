...
exports.gamefiParams = exports.tokenBalanceParams = exports.tokenParams = exports.limitOffetParams = exports.timeRangeParams = exports.nftParams = exports.nftBalanceParams = exports.nftWashTradeCheckerParams = exports.ALL_OPERATIONS = exports.CHAIN_OPERATIONS = exports.GAMEFI_OPERATIONS = exports.TOKEN_OPERATIONS = exports.NFT_OPERATIONS = exports.chainInputParameters = void 0;
exports.chainInputParameters = [
    {
        label: 'Chain',
        name: 'chain',
        type: 'options',
...
exports.NFT_OPERATIONS = [
    ...
    },
    {
        ...
        description: 'Returns the statistics metrics (eg:market_cap,volume,floor_price) timeseries data or all metrics data of the NFT collection.',
        endpoint: 'https://api.footprint.network/api/v2/nft/collection/statistics'
    },
    {
        label: 'NFT Statistics',
        name: 'nftStatistics',
        description: 'Returns all metrics of NFT different time models statistics by collection and nft_token_id.Currently only the latest state of NFT statistics.',
...
exports.ALL_OPERATIONS = [...exports.NFT_OPERATIONS, ...exports.TOKEN_OPERATIONS, ...exports.GAMEFI_OPERATIONS, ...exports.CHAIN_OPERATIONS];
exports.nftWashTradeCheckerParams = [
    {
