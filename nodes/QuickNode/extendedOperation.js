...
exports.platformOperations = exports.fantomOperations = exports.fantomOperationsNetworks = exports.avaxOperations = exports.avaxOperationsNetworks = exports.tokenOperations = exports.tokenOperationsNetworks = exports.nftOperations = exports.solanaNetworks = exports.nftOperationsNetworks = exports.traceOperations = exports.traceOperationsNetworks = exports.arbTraceOperations = exports.arbTraceOperationsNetworks = exports.debugOperations = exports.debugOperationsNetworks = void 0;
const ChainNetwork_1 = require("../../src/ChainNetwork");
const ETHOperations_1 = require("../../src/ETHOperations");
exports.debugOperationsNetworks = [...ETHOperations_1.infuraSupportedNetworks, ChainNetwork_1.NETWORK.ARBITRUM_NOVA, ChainNetwork_1.NETWORK.BSC, ChainNetwork_1.NETWORK.BSC_TESTNET, ChainNetwork_1.NETWORK.CELO];
exports.debugOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.debugOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.arbTraceOperationsNetworks = [ChainNetwork_1.NETWORK.ARBITRUM, ChainNetwork_1.NETWORK.ARBITRUM_GOERLI];
exports.arbTraceOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.arbTraceOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.traceOperationsNetworks = [ChainNetwork_1.NETWORK.MAINNET, ChainNetwork_1.NETWORK.GÖRLI, ChainNetwork_1.NETWORK.GNOSIS, ChainNetwork_1.NETWORK.BSC, ChainNetwork_1.NETWORK.BSC_TESTNET, ChainNetwork_1.NETWORK.FANTOM];
exports.traceOperations = [
    {
        ...
        description: 'Returns traces created at given block (Trace Mode required, and supported only on OpenEthereum & Erigon).',
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.traceOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.nftOperationsNetworks = [ChainNetwork_1.NETWORK.MAINNET, ChainNetwork_1.NETWORK.GÖRLI, ChainNetwork_1.NETWORK.BSC, ChainNetwork_1.NETWORK.BSC_TESTNET];
exports.solanaNetworks = [ChainNetwork_1.NETWORK.SOLANA, ChainNetwork_1.NETWORK.SOLANA_DEVNET, ChainNetwork_1.NETWORK.SOLANA_TESTNET];
exports.nftOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.nftOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
  ...
  "contracts": [
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: [...exports.nftOperationsNetworks, ...exports.solanaNetworks]
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
  ...
  "contracts": [
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.solanaNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.tokenOperationsNetworks = [ChainNetwork_1.NETWORK.MAINNET, ChainNetwork_1.NETWORK.GÖRLI, ChainNetwork_1.NETWORK.BSC, ChainNetwork_1.NETWORK.BSC_TESTNET];
exports.tokenOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.tokenOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.avaxOperationsNetworks = [ChainNetwork_1.NETWORK.AVALANCHE, ChainNetwork_1.NETWORK.AVALANCHE_TESTNET];
exports.avaxOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.avaxOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.fantomOperationsNetworks = [ChainNetwork_1.NETWORK.FANTOM];
exports.fantomOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.fantomOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
//# sourceMappingURL=extendedOperation.js.map