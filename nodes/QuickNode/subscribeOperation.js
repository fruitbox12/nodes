...
exports.unsubscribeOperations = exports.subscribeOperations = exports.subsOperationsNetworks = void 0;
...
exports.subsOperationsNetworks = [
    ...ETHOperations_1.infuraSupportedNetworks,
...
exports.subscribeOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.subsOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: solanaOperation_1.solanaOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
//# sourceMappingURL=subscribeOperation.js.map