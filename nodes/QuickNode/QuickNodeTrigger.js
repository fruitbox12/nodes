...
class QuickNodeTrigger extends events_1.default {
    constructor() {
        super();
        this.loadMethods = {
            async getSubscribeOperations(nodeData) {
                ...
                const filteredOperations = totalOperations.filter((op) => Object.prototype.hasOwnProperty.call(op.providerNetworks, 'quicknode') &&
  ...
  "param2"
    ...
    async runTrigger(nodeData) {
        ...
        // GET credentials
        const wssProvider = credentials.wssProvider;
...
//# sourceMappingURL=QuickNodeTrigger.js.map