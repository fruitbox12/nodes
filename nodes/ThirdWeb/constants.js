...
exports.voteParameters = exports.tokenDropParameters = exports.splitContractParameters = exports.multiWrapParameters = exports.marketplaceParameters = exports.nftDropParameters = void 0;
const src_1 = require("../../src");
exports.nftDropParameters = [
    {
        label: 'Name',
        name: 'name',
    ...
    },
    {
        ...
        show: {
            'actions.operation': ['deploy'],
            'inputParameters.fee_recipient': src_1.notEmptyRegex,
            'inputParameters.contractType': ['nft-drop', 'nft-collection', 'edition', 'edition-drop', 'pack', 'signature-drop']
        }
    },
    {
    ...
    },
    {
        ...
        show: {
            'actions.operation': ['deploy'],
            'inputParameters.platform_fee_recipient': src_1.notEmptyRegex,
            'inputParameters.contractType': ['nft-drop', 'nft-collection', 'edition', 'edition-drop', 'pack', 'signature-drop']
        }
    },
    {
...
exports.splitContractParameters = [
    {
        label: 'Name',
        name: 'name',
        description: 'Name of the contract',
