...
exports.tokenAPIOperations = exports.transactionReceiptsOperations = exports.getContractsForOwnerProperties = exports.getNFTSalesProperties = exports.isHolderOfCollectionProperties = exports.searchContractMetadataProperties = exports.getOwnersForTokenProperties = exports.getOwnersForCollectionProperties = exports.getNFTsForCollectionProperties = exports.getNFTMetadataProperties = exports.getNFTsProperties = exports.NFTOperationsOptions = void 0;
const src_1 = require("../../src");
exports.NFTOperationsOptions = [
    {
        label: 'Get NFTs',
        name: 'getNFTs',
    ...
    },
    {
        ...
        show: {
            'networks.network': [src_1.NETWORK.MAINNET]
        }
    },
    {
...
exports.getNFTMetadataProperties = [
    {
...
exports.getNFTsForCollectionProperties = [
    {
        label: 'Contract Address',
        name: 'contractAddress',
        type: 'string',
...
exports.getOwnersForCollectionProperties = [
    {
        label: 'Contract Address',
        name: 'contractAddress',
        type: 'string',
...
exports.getOwnersForTokenProperties = [
    {
        label: 'Contract Address',
        name: 'contractAddress',
        type: 'string',
...
exports.searchContractMetadataProperties = [
    {
        label: 'Query',
        name: 'query',
        type: 'string',
...
exports.isHolderOfCollectionProperties = [
    {
        label: 'Contract Address',
        name: 'contractAddress',
        type: 'string',
...
exports.getContractsForOwnerProperties = [
    {
        label: 'Owner',
        name: 'owner',
        type: 'string',
...
exports.transactionReceiptsOperations = [
    {
        ...
        providerNetworks: {
            alchemy: [src_1.NETWORK.MAINNET, src_1.NETWORK.GÖRLI, src_1.NETWORK.MATIC, src_1.NETWORK.MATIC_MUMBAI, src_1.NETWORK.ARBITRUM, src_1.NETWORK.ARBITRUM_GOERLI]
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.tokenAPIOperations = [
    {
        ...
        providerNetworks: {
            alchemy: [
                src_1.NETWORK.MAINNET,
                src_1.NETWORK.GÖRLI,
                src_1.NETWORK.MATIC,
                src_1.NETWORK.MATIC_MUMBAI,
                src_1.NETWORK.ARBITRUM,
                src_1.NETWORK.ARBITRUM_GOERLI,
                src_1.NETWORK.OPTIMISM,
                src_1.NETWORK.OPTIMISM_GOERLI
            ]
        },
        method: 'POST',
        body: {
