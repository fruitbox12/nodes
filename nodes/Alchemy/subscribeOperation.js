...
exports.unsubscribeOperations = exports.subscribeOperations = exports.solanaOperationsNetworks = exports.subsOperationsNetworks = void 0;
const ChainNetwork_1 = require("../../src/ChainNetwork");
const ETHOperations_1 = require("../../src/ETHOperations");
exports.subsOperationsNetworks = [...ETHOperations_1.alchemySupportedNetworks];
exports.solanaOperationsNetworks = [ChainNetwork_1.NETWORK.SOLANA, ChainNetwork_1.NETWORK.SOLANA_DEVNET, ChainNetwork_1.NETWORK.SOLANA_TESTNET];
exports.subscribeOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.ALCHEMY]: exports.subsOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.ALCHEMY]: exports.solanaOperationsNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
