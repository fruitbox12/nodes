                ...
                options: [
                    {
                        ...
                        name: constants_1.GET_ETHER_BALANCE.name,
                    ...
                    },
                    {
                        ...
                        name: constants_1.GET_MULTI_ETHER_BALANCE.name,
                    ...
                    },
                    {
                        ...
                        name: constants_1.CHECK_CONTRACT_EXECUTION_STATUS.name,
        ...
        this.inputParameters = [
            {
                ...
                show: {
                    'actions.api': [
                        constants_1.GET_ETHER_BALANCE.name,
            ...
            },
            {
                ...
                show: {
                    'actions.api': [
                        constants_1.GET_INTERNAL_TRANSACTIONS_BY_HASH.name,
                        constants_1.CHECK_TRANSACTION_RECEIPT_STATUS.name,
                        constants_1.CHECK_CONTRACT_EXECUTION_STATUS.name
                    ]
                }
            },
            {
                ...
                show: {
                    'actions.api': [constants_1.GET_ERC20_TOKEN_SUPPLY.name, constants_1.GET_ERC20_TOKEN_BALANCE.name]
                }
            },
            {
                label: 'Tag',
...
//# sourceMappingURL=Arbiscan.js.map