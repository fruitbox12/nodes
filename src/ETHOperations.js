...
exports.polygonOperations = exports.ethOperations = exports.qnSupportedNetworks = exports.infuraSupportedNetworks = exports.alchemySupportedNetworks = exports.operationCategoryMapping = void 0;
const ChainNetwork_1 = require("./ChainNetwork");
exports.operationCategoryMapping = {
...
exports.alchemySupportedNetworks = [
    ...
    ChainNetwork_1.NETWORK.OPTIMISM,
    ChainNetwork_1.NETWORK.OPTIMISM_GOERLI,
    ChainNetwork_1.NETWORK.ARBITRUM,
    ChainNetwork_1.NETWORK.ARBITRUM_GOERLI
];
exports.infuraSupportedNetworks = [...exports.alchemySupportedNetworks, ChainNetwork_1.NETWORK.AVALANCHE, ChainNetwork_1.NETWORK.AVALANCHE_TESTNET];
exports.qnSupportedNetworks = [
    ...exports.infuraSupportedNetworks,
    ChainNetwork_1.NETWORK.ARBITRUM_NOVA,
    ChainNetwork_1.NETWORK.GNOSIS,
    ChainNetwork_1.NETWORK.BSC,
    ChainNetwork_1.NETWORK.BSC_TESTNET,
    ChainNetwork_1.NETWORK.FANTOM,
    ChainNetwork_1.NETWORK.CELO
];
exports.ethOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.ALCHEMY]: exports.alchemySupportedNetworks,
            [ChainNetwork_1.NETWORK_PROVIDER.INFURA]: exports.infuraSupportedNetworks,
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: exports.qnSupportedNetworks
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
        ...
        exampleParameters: `[
  {
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.ALCHEMY]: [ChainNetwork_1.NETWORK.MAINNET, ChainNetwork_1.NETWORK.GÖRLI, ChainNetwork_1.NETWORK.OPTIMISM, ChainNetwork_1.NETWORK.OPTIMISM_GOERLI],
            [ChainNetwork_1.NETWORK_PROVIDER.INFURA]: exports.infuraSupportedNetworks
        },
        method: 'POST',
        body: {
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: [ChainNetwork_1.NETWORK.OPTIMISM, ChainNetwork_1.NETWORK.OPTIMISM_GOERLI]
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
  ...
  "latest"
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.ALCHEMY]: [ChainNetwork_1.NETWORK.MAINNET, ChainNetwork_1.NETWORK.GÖRLI],
            [ChainNetwork_1.NETWORK_PROVIDER.INFURA]: exports.infuraSupportedNetworks
        },
        method: 'POST',
        body: {
        ...
        exampleParameters: `[
  {
    ...
    },
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.QUICKNODE]: [ChainNetwork_1.NETWORK.MAINNET, ChainNetwork_1.NETWORK.GÖRLI, ChainNetwork_1.NETWORK.BSC, ChainNetwork_1.NETWORK.BSC_TESTNET]
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
exports.polygonOperations = [
    {
        ...
        providerNetworks: {
            [ChainNetwork_1.NETWORK_PROVIDER.ALCHEMY]: [ChainNetwork_1.NETWORK.MATIC, ChainNetwork_1.NETWORK.MATIC_MUMBAI],
            [ChainNetwork_1.NETWORK_PROVIDER.INFURA]: [ChainNetwork_1.NETWORK.MATIC, ChainNetwork_1.NETWORK.MATIC_MUMBAI]
        },
        method: 'POST',
        body: {
            jsonrpc: '2.0',
...
//# sourceMappingURL=ETHOperations.js.map